...
# Removes all third party search results from the default Ubuntu Desktop environment
#  This code was copied from https://fixubuntu.com/ but works like a champ!
